 ...
 */
solarSystem.forEach(i => console.log(`${i.name} is beautiful`))
/*
 * Create an array of all the planet names.
 */
newArr = []
solarSystem.forEach(x => newArr.push(x.name))
console.log(newArr);
/*
 * Create an array of planets that do have a ringSystem
 */
newArr2 = []
solarSystem.forEach(x => {if (x.ringSystem == true) {
  newArr2.push(x.name)
}})
console.log(newArr2);
/*
 ...
 */
newArr3 = []
solarSystem.forEach(x => {if (x.moons.length >= 3) {
  newArr3.push(x.name)
}})
console.log(newArr3);
/*
